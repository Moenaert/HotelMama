...
@Component
@SessionAttributes(AppConfig.messageModelAttributeName)
class Receiver {
    var message: String? = null
        private set

    @JmsListener(destination = "TodoWebApplication", containerFactory = "myFactory")
    fun receiveMessage(message: JmsMessage) {
